# 567-personal-knowledgedatabase skill（5鹿7 个人知识库）总体设计方案

> 版本 v0.2.0 · 状态：暂缓（2026-08-23 决策更新，见 §7 各条「已裁决/已确认」标注）
> 官方名称（用户裁定 2026-08-24）：**567-personal-knowledgedatabase skill**（中文名
> 「5鹿7个人知识库skill」）。它是一个 skill（个人知识库技能包），不是「系统」；
> 仓库目录名 personal-knowledge-os 保留为历史路径，junction 安装名不变。
> 目标：不是单纯的知识库，而是一套稳定、可演化的个人知识工作流——先锁死输入格式保证稳定，再逐步开放扩展。
