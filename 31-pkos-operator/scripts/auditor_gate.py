#!/usr/bin/env python3
"""31-pkos-operator:1 机器守卫 — 调用方人格与行为拦截 (v4.2 / v4.8 词表扩五值)
...
for _p in (ROOT / "10-pkos-html" / "scripts",):
...
def main(argv: list[str]) -> int:
    ap = argparse.ArgumentParser(description="31-pkos-operator:1 machine guard")
