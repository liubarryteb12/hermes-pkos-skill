# PKOS v2 e2e report (2026-08-28T04:00:10Z)
...
### maintenance.index (exit=0, 3.32s)
...
### audit.lint.report-only (exit=0, 1.1s)
...
### capability_runner (exit=1, 7.14s)
...
### contract_refs (exit=0, 0.15s)
  ...
  === 19 SKILL.md 扫描完成，0 错误 ===

### validate_entry (exit=0, 1.56s)
