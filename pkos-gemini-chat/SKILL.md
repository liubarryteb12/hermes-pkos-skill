...
```bash
python pkos-gemini-chat/scripts/gemini_chat.py --prompt "你的问题" --out-dir "D:/.../workspace/gemini-chat"
python pkos-gemini-chat/scripts/gemini_chat.py --prompt-file q.txt --timeout 180 --session gemini-pkos
```
