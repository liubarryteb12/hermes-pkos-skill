...
```bash
python pkos-operator/scripts/auditor_gate.py --assemble --persona archivist --breaker STRICT
python pkos-operator/scripts/auditor_gate.py --persona-violation rt.json --actions actions.json   # §5-1 越界
python pkos-operator/scripts/auditor_gate.py --breaker-state metrics.json                          # §4 断路器
python pkos-operator/scripts/auditor_gate.py --check-defiance AUTO_MERGE --actions actions.json    # §5-2 抗命
python pkos-operator/scripts/auditor_gate.py --check-dogma reasons.jsonl                           # §5-3 教条
python pkos-operator/scripts/auditor_gate.py --selftest
```
