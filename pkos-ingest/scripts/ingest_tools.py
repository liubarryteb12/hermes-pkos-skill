#!/usr/bin/env python3
"""pkos-ingest 工具集 —— SKILL.md 第⓪节的脚本层硬编码保险（第三处冗余）。
...
UA = "pkos-ingest/0.1 (personal knowledge os; respectful fetcher)"
TIMEOUT_S = 90
...
def main(argv=None) -> int:
    ap = argparse.ArgumentParser(description="pkos-ingest 工具集")
