...
for _p in (ROOT / "tests", ROOT / "10-pkos-html" / "scripts", ROOT / "22-pkos-soulselect" / "scripts"):
...
def selftest() -> int:
    ...
    ctx = {
        ...
        "system_state": {"modules_enabled": ["10-pkos-html"], "quarantine_count": 0, "drafts_in_ttl": 0, "vault_clean": True},
